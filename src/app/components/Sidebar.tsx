...
const Sidebar: React.FC = () => {
  ...
  return (
    <>
      ...
      <div
        className="lg:hidden cursor-pointer fixed z-10 w-full h-[5%] flex justify-between items-center mt-8"
        onClick={toggleMenu}
      >
        {isMenuOpen ? (
          <div className="flex w-[100vw] justify-end items-center mt-8">
